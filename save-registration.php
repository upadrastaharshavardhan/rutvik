...
if (file_exists($excelFile)) {
    ...
    $sheet->setCellValue('A1', 'Name')
          ...
          ->setCellValue('D1', 'Experience')
          ->setCellValue('E1', 'Role')
          ->setCellValue('F1', 'Overview');
}
...
$sheet->setCellValue('A' . $row, $name)
      ...
      ->setCellValue('D' . $row, $experience)
      ->setCellValue('E' . $row, $role)
      ->setCellValue('F' . $row, $overview);
...
echo "Registration successful. Your details have been saved.";
?>
